...
const socials = [
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/alquamahansari",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://formspree.io/f/xbgjqwpk", {
        method: "POST",
        headers: {
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-24 items-start">
        ...
        <div className="space-y-10">
          ...
          <p className="font-['Inter'] text-[#8fcef5] text-base font-light leading-relaxed">
            I'm actively looking for Software Engineer / Backend Developer roles.
            If you're building something that needs solid backend work, let's talk.
          </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              {status === "error" && (
                <p className="text-red-400 text-sm text-center">
                  ...
                  <a href="mailto:alquamahansari@gmail.com" className="underline">
                    alquamahansari@gmail.com
                  </a>.
                </p>
              )}
              ...
              <button
                ...
                className="w-full bg-[#00C9A7] text-[#00382d] font-['Space_Grotesk'] font-bold py-4 uppercase tracking-widest text-sm hover:brightness-110 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
